 ...
 * @tree: a double the pointer to root node of the BST to insert the value
 * @value: the value to store in the node
 * If the address stored in tree is NULL, the node becomes root
...
bst_t *bst_insert(bst_t **tree, int value)
{
	...
	return (new_nd); /* returns new node */
}
